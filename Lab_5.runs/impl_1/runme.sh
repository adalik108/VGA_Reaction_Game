...
HD_PWD='C:/Users/Taha Hamdy/Desktop/Aux Work/Bluetooth/VGA_Reaction_Game-Lab_5/VGA_Reaction_Game-Lab_5/Lab_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Game_Top_Level.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Game_Top_Level.tcl -notrace
