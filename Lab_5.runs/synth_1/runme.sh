...
HD_PWD='C:/Users/Taha Hamdy/Desktop/Aux Work/Bluetooth/VGA_Reaction_Game-Lab_5/VGA_Reaction_Game-Lab_5/Lab_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Game_Top_Level.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Game_Top_Level.tcl
