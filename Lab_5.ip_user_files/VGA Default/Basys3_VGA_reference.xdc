...
set_property IOSTANDARD LVCMOS33 [get_ports modecntrl]
...
set_property IOSTANDARD LVCMOS33 [get_ports button_1_BT]
##Sch name = JB8
set_property PACKAGE_PIN A17 [get_ports button_2_BT]
set_property IOSTANDARD LVCMOS33 [get_ports button_2_BT]
##Sch name = JB9
set_property PACKAGE_PIN C15 [get_ports button_3_BT]
set_property IOSTANDARD LVCMOS33 [get_ports button_3_BT]
##Sch name = JB10
set_property PACKAGE_PIN C16 [get_ports button_4_BT]
set_property IOSTANDARD LVCMOS33 [get_ports button_4_BT]
