...
#set_property PACKAGE_PIN E19 [get_ports {buzzerout}]					
...
##Pmod Header JB
##Sch name = JB1
#set_property PACKAGE_PIN A14 [get_ports {buzzerout}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {buzzerout}]
##Sch name = JB2
...
##Sch name = JB4
#set_property PACKAGE_PIN B16 [get_ports {buzzerout}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {buzzerout}]
##Sch name = JB7
#set_property PACKAGE_PIN A15 [get_ports {buzzerout}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {buzzerout}]
##Sch name = JB8
